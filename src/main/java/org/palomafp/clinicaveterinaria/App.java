...
public class App {
    ...
    /**
     * Constructor por defecto de App.
     */
    public App() {
    }
    ...
    public static void main(String[] args) {
        ...
        /**
         * Variable boolean que sirve para repetir el menú de forma constante hasta que
         * el usuario decida salir.
         */
        boolean bucleMenu = true;
        /**
         * Variable de tipo int que sirve para poder seleccionar las opciones del menú
         * asignándole el valor mediante el Scanner.
         */
        int opcionesMenu;
        ...
        try {
            ...
            do {
                ...
                // Switch que usa el valor de la variable opcionesMenu para poder moverse entre
                ...
                switch (opcionesMenu) {
                    ...
                    // Opción que se ejecuta por defecto en caso de que el valor introducido para la
                    // variable opcionesMenu sea distinto de los establecidos en los case.
                    default:
